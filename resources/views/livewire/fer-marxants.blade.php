<div class="bg-white p-8 rounded-lg shadow-lg mt-8 w-full max-w-lg">
                ...
                <div class="mt-2 grid grid-cols-3 gap-2">
                    @foreach($imatges_existents as $index => $imatge)
                        <div class="relative p-2 bg-white border border-gray-200 rounded-xl">
                            <img src="{{ Storage::url($imatge) }}" class="mb-2 w-full h-32 object-cover rounded-lg">
                    ...
                    @foreach($fitxers_existents as $index => $fitxer)
                        <div class="relative p-2 bg-white border border-gray-200 rounded-xl">
                            <div class="flex items-center gap-x-3">
                                ...
                                <span class="text-sm text-gray-800">{{ $fitxer['nom'] ?? 'Fitxer' }}</span>
                            </div>
